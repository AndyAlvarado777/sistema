...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="bi bi-person-badge-fill" type="image/png" sizes="16x16 32x32 48x48 64x64">                <title>Panel de Usuario</title>
    ...
    <body class="sb-nav-fixed">
            ...
            <?php 
            require_once("vistas/Roles/user/menu.php");
            ?>
            <div id="layoutSidenav_content">
                ...
                <?php 
            require_once("vistas/Roles/user/footer.php");
            ?>
    </body>
</html>
